    ...
    db.collection(collection).get()   //the collection called "hikes"
        .then(allHikes => {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                var docID = doc.id;                 // get value for hike doc
                ...
                // check if the hike is already bookedmarked
                // go to the users document and check if the bookmarks array already includes the doc Id
                // if so, then display the bookmark
                currentUser.get().then(userDoc => {
                    //get the user name
